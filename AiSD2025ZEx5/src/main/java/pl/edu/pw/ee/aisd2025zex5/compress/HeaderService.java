...
import pl.edu.pw.ee.aisd2025zex5.compress.BitOutputStream;
...
public class HeaderService {
    ...
    public void writeTree(BitOutputStream bitOut, HuffmanNode node) throws IOException {
        ...
        // ZMIANA: NIE zapisujemy (byte) data.length!
        // Wiemy, że data.length jest ZAWSZE równe sequenceLength (dzięki paddingowi).
